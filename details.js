...
function createDataBlockWrapperElement() {
    ...
    dataBlockWrapperElement.append(nameElement, dataBlockElement);//вставить элемент в конец
...
function createInfoElement() {
    ...
    const dataBlockSideElement = createDataBlockElementFromTemplate("side", createButtonContainerSideElement);
    const dataBlockColorElement = createDataBlockElementFromTemplate("color", createButtonContainerColorElement);
